(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/forms"), require("@angular/core"), require("@angular/material"), require("@angular/flex-layout"), require("rxjs/Observable"), require("@angular/router"), require("rxjs/add/observable/forkJoin"), require("@angular/common"), require("rxjs/add/operator/filter"));
	else if(typeof define === 'function' && define.amd)
		define("@firestitch/filter", ["@angular/forms", "@angular/core", "@angular/material", "@angular/flex-layout", "rxjs/Observable", "@angular/router", "rxjs/add/observable/forkJoin", "@angular/common", "rxjs/add/operator/filter"], factory);
	else if(typeof exports === 'object')
		exports["@firestitch/filter"] = factory(require("@angular/forms"), require("@angular/core"), require("@angular/material"), require("@angular/flex-layout"), require("rxjs/Observable"), require("@angular/router"), require("rxjs/add/observable/forkJoin"), require("@angular/common"), require("rxjs/add/operator/filter"));
	else
		root["@firestitch/filter"] = factory(root["@angular/forms"], root["@angular/core"], root["@angular/material"], root["@angular/flex-layout"], root["rxjs/Observable"], root["@angular/router"], root["rxjs/add/observable/forkJoin"], root["@angular/common"], root["rxjs/add/operator/filter"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE__angular_forms__, __WEBPACK_EXTERNAL_MODULE__angular_core__, __WEBPACK_EXTERNAL_MODULE__angular_material__, __WEBPACK_EXTERNAL_MODULE__angular_flex_layout__, __WEBPACK_EXTERNAL_MODULE_rxjs_Observable__, __WEBPACK_EXTERNAL_MODULE__angular_router__, __WEBPACK_EXTERNAL_MODULE_rxjs_add_observable_forkJoin__, __WEBPACK_EXTERNAL_MODULE__angular_common__, __WEBPACK_EXTERNAL_MODULE_rxjs_add_operator_filter__) {
...
/***/ "../node_modules/@firestitch/datepicker/index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FsDatepickerModule", function() { return FsDatepickerModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("@angular/forms");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__angular_forms__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material__ = __webpack_require__("@angular/material");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__angular_material__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__firestitch_common__ = __webpack_require__("../node_modules/@firestitch/common/common.umd.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__firestitch_common___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__firestitch_common__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_iscroll__ = __webpack_require__("../node_modules/iscroll/build/iscroll.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_iscroll___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_iscroll__);
...
var DATEPICKER_VALUE_ACCESSOR = {
    ...
    useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["forwardRef"])(function () { return FsDatepickerDirective; }),
    multi: true
};
...
var FsDatepickerDialogComponent = (function () {
    function FsDatepickerDialogComponent(element, FsUtil$$1, _iterableDiffers) {
        ...
        this.today = {
            date: __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().format('YYYY-MM-DD'),
            month: __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().format('M'),
            year: parseInt(__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().format('YYYY'))
        };
        this.dateDays = [];
            ...
            if (this.parentInstance.disabledDays !== undefined && this.month) {
                for (var _i = 0, _a = this.month.weeks; _i < _a.length; _i++) {
                    ...
                    for (var _b = 0, week_1 = week; _b < week_1.length; _b++) {
                        var day = week_1[_b];
                        day.disabled = this.isDayDisabled(__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(day.date));
                    }
                }
            }
        }
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.checkDisabledTime = /**
     * @return {?}
     */
    function () {
        this.disabledTimeMinutes = {};
        ...
        if (this.parentInstance.disabledTimes !== undefined) {
            for (var _d = 0, _e = this.parentInstance.disabledTimes; _d < _e.length; _d++) {
                var range = _e[_d];
                var /** @type {?} */ min = Math.min(range[0], range[1]);
                var /** @type {?} */ max = Math.max(range[0], range[1]);
                var /** @type {?} */ minMinutes = min % 60;
                var /** @type {?} */ maxMinutes = max % 60;
                var /** @type {?} */ minHour = Math.floor(min / 60);
                var /** @type {?} */ maxHour = Math.floor(max / 60);
                for (var /** @type {?} */ h = 0; h <= 24; h++) {
                    ...
                    if (h == minHour) {
                        for (var /** @type {?} */ m = minMinutes; m < 60; m++) {
                            this.disabledGroupedMinutes[h][m] = true;
                        }
                    }
                    if (h == maxHour) {
                        for (var /** @type {?} */ m = 0; m < maxMinutes; m++) {
                            this.disabledGroupedMinutes[h][m] = true;
                        }
                    }
                }
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.addDisabledMinutes = /**
     * @param {?} range
     * @return {?}
     */
    function (range) {
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.addDisabledHours = /**
     * @param {?} range
     * @return {?}
     */
    function (range) {
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.updateDateDays = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ year = this.parentInstance.selected.year || 1904;
        var /** @type {?} */ month = this.parentInstance.selected.month || 1;
        var /** @type {?} */ max = new Date(year, month, 0).getDate();
        this.dateDays = [];
        for (var /** @type {?} */ d = 1; d <= max; d++) {
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.monthDateViewChange = /**
     * @return {?}
     */
    function () {
        this.updateDateDays();
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.dayDateViewChange = /**
     * @return {?}
     */
    function () {
        this.updateDateDays();
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.yearDateViewChange = /**
     * @return {?}
     */
    function () {
        this.updateDateDays();
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.updateDate = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ m = __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()([this.parentInstance.selected.year, this.parentInstance.selected.month - 1, this.parentInstance.selected.day]);
        var /** @type {?} */ max = new Date(this.parentInstance.selected.year || 1904, this.parentInstance.selected.month, 0).getDate();
     ...
     */
    function () {
        return __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().startOf('day');
    };
    /**
     * @param {?} date
     * @return {?}
    ...
    function (md) {
        ...
        for (var /** @type {?} */ i = 0, /** @type {?} */ len_1 = this.parentInstance.disabledDays.length; i < len_1; i++) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default.a.isMoment(value)) {
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.hourClick = /**
     * @param {?} hour
     * @return {?}
     */
    function (hour) {
     ...
     * @return {?}
     */
    FsDatepickerDialogComponent.prototype.minuteClick = /**
     * @param {?} minute
     * @return {?}
     */
    function (minute) {
    ...
    FsDatepickerDialogComponent.ctorParameters = function () { return [
        ...
        { type: __WEBPACK_IMPORTED_MODULE_4__firestitch_common__["FsUtil"], },
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["IterableDiffers"], },
    ]; };
    FsDatepickerDialogComponent.propDecorators = {
        "documentKeydown": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"], args: ['document:keydown', ['$event'],] },],
    };
...
var FsDatepickerDialogFactory = (function () {
    ...
    FsDatepickerDialogFactory.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"], args: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ComponentFactoryResolver"],] },] },
    ]; };
...
var FsDatepickerDirective = (function () {
    ...
    function () {
        ...
        this.minYear = this.minYear || (parseInt(__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().format('YYYY')) - 100);
        this.maxYear = this.maxYear || (parseInt(__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()().format('YYYY')) + 100);
    ...
    function (value) {
        if (value) {
            if (__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(value).isValid()) {
                value = __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(value);
            }
            else {
                value = undefined;
            }
     ...
     */
    function () {
        return this._model ? __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(this._model) : this._model;
    };
    /**
     * @return {?}
     */
    ...
    function (input) {
        ...
        if (this.FsUtil.isInt(value)) {
            value = __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(new Date(value));
        }
            ...
            if (__WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(value).isValid()) {
                ...
                value = __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(Date.parse(value));
            }
        }
        if (value && __WEBPACK_IMPORTED_MODULE_5_moment_timezone___default()(value).isValid()) {
            if (this.hasDate) {
    ...
    FsDatepickerDirective.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"], args: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ComponentFactoryResolver"],] },] },
        { type: undefined, decorators: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"], args: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewContainerRef"],] },] },
        { type: FsDatepickerDialogFactory, },
        { type: __WEBPACK_IMPORTED_MODULE_4__firestitch_common__["FsUtil"], },
    ]; };
    FsDatepickerDirective.propDecorators = {
        "hasCalendar": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['hasCalendar',] },],
        "hasDate": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['hasDate',] },],
        "minYear": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['minYear',] },],
        "maxYear": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['maxYear',] },],
        "hasTime": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['hasTime',] },],
        "view": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['view',] },],
        "disabledDays": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['disabledDays',] },],
        "disabledMinutes": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
        "disabledHours": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
        "disabledTimes": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
        "change$": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"], args: ['change',] },],
...
var FsIsscrollDirective = (function () {
    ...
    function () {
        ...
        setTimeout(function () {
            var /** @type {?} */ instance = new __WEBPACK_IMPORTED_MODULE_6_iscroll___default.a(_this.element.nativeElement, _this.fsOptions);
    ...
    FsIsscrollDirective.propDecorators = {
        "fsOptions": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['fsOptions',] },],
        "fsInstance": [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"], args: ['fsInstance',] },],
    };
    ...
    FsDatepickerModule.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"], args: [{
                    ...
                    providers: [
                        ...
                        __WEBPACK_IMPORTED_MODULE_4__firestitch_common__["FsUtil"]
                    ],
                    entryComponents: [
                        FsDatepickerDialogComponent
                    ],
...
/***/ "../node_modules/@firestitch/store/store.umd.js":
/***/ (function(module, exports, __webpack_require__) {

(function (global, factory) {
	 true ? factory(exports, __webpack_require__("@angular/core"), __webpack_require__("rxjs/Observable"), __webpack_require__("rxjs/add/operator/filter"), __webpack_require__("../node_modules/@firestitch/common/common.umd.js"), __webpack_require__("@angular/common")) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable', 'rxjs/add/operator/filter', '@firestitch/common', '@angular/common'], factory) :
	(factory((global.store = {}),global.core,global.Observable,null,global.common,global.common$1));
}(this, (function (exports,core,Observable,filter,common,common$1) { 'use strict';
...
var moment = module.exports = __webpack_require__("../node_modules/moment-timezone/moment-timezone.js");
moment.tz.load(__webpack_require__("../node_modules/moment-timezone/data/packed/latest.json"));
...
module.exports = __WEBPACK_EXTERNAL_MODULE__angular_flex_layout__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_rxjs_add_observable_forkJoin__;
